...
const Footer = () => (
    <div className="row-start-3 flex gap-6 flex-wrap items-center justify-center md:container-xl sm:mx-auto bg-beige relative h-90 w-full md:pt-20 pt-5 pb-10 px-7">
            ...
            <div className='md:w-1/2 pl-3'>
                ...
                <div className='flex flex-col gap-2 md:gap-4 place-content-left py-4 md:py-8 item-top'>
                    ...
                    <div className='flex flex-row leading-3 md:leading-9 gap-8'>
                        ...
                        <a title='address' target='_blank' className='font-semibold text-xs sm:text-sm md:text-lg text-mainBlack hover:text-darkRed hover:underline' href='https://maps.app.goo.gl/34JsEahJSXGMffT77'>Nanyang Drive blahblah</a>
                    </div>
        ...
        {/* Below footer */}
        <div className='md:container-xl md:mx-auto bg-darkRed absolute inset-x-0 bottom-0 w-full text-center pb-1'>
            <span className='font-semibold text-[8px] md:text-xs text-mainBlack tracking-wide'>©UShop 2024 </span>
            <span className='font-semibold text-[8px] md:text-xs text-mainBlack tracking-wide'>Company Registration No.: afkafj</span>
        </div>
    </div>
)
